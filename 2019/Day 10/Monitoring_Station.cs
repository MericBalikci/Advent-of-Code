...
public static class Monitoring_Station
{
    ...
    /// 
    /// </summary>
    public static Dictionary<double, List<Asteroid>> AsteroidCountsAtLineOfSight =
        new Dictionary<double, List<Asteroid>>();
    ...
    {
        int lineNumber = 0;
        List<string> lines = File.ReadAllLines(Program.DefaultInputPath + "/Day 10.txt").ToList();
    ...
    /// </summary>
    public static void DebugAsteroidMap()
    {
